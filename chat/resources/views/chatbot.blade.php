        ...
        !(function(e, t) {
                ...
                function Ce(d, h, g, v, y, e) {
                    return (
                        ...
                        le(function(e, t, n, r) {
                            ...
                            } else(p = Te(p === t ? p.splice(l, p.length) : p)), y ? y(null, t, p, r) :
                                H.apply(t, p);
                        })
                    );
                }
            ...
            function Pe(n, r, i, o) {
                ...
                if (
                    ...
                    if (s)
                        for (
                            l = a[a.length - 1].ownerDocument, S.map(a, He), c = 0; c < s; c++
                        )
                            (u = a[c]),
                            he.test(u.type || "") &&
            ...
            S.extend({
                    ...
                    clone: function(e, t, n) {
                        ...
                        if (t)
                            if (n)
                                for (
                                    o = o || ve(e), a = a || ve(c), r = 0, i = o.length; r < i; r++
                                )
                                    Oe(o[r], a[r]);
                            else Oe(e, c);
                        return (
                    ...
                    cleanData: function(e) {
                        for (
                            var t, n, r, i = S.event.special, o = 0; void 0 !== (n = e[o]); o++
                        )
                            if (V(n)) {
                                if ((t = n[Y.expando])) {
                                    if (t.events)
                ...
                S.each({
                    ...
                    function(e, a) {
                        S.fn[e] = function(e) {
                            for (
                                var t, n = [], r = S(e), i = r.length - 1, o = 0; o <= i; o++
                            )
